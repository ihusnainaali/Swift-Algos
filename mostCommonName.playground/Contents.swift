...
func mostCommonNameFromGivenArray(array:[String]) -> String {
...
print("Most Common Name: ", mostCommonNameFromGivenArray(array: ["bheema", "brajesh", "bheema", "ankit", "bheema", "manoj", "prashant", "manoj", "bheema"]))
